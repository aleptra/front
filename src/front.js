...
var app = previousApp || {
  ...
  resetStyles: function () {
    ...
    style.textContent = '*, *::before, *::after { box-sizing:border-box } ' +
      'html { display:flex; width:100%; padding-top:env(safe-area-inset-top); padding-bottom:env(safe-area-inset-bottom) }' +
      'body { width:100%; min-height:100vh; line-height:1.5; -webkit-font-smoothing:antialiased } ' +
