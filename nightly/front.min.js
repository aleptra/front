...
element = element instanceof Object ? element : app.element.select(element)
...
var op = operation[0],
operand = parseFloat(operation.slice(1)) || 1
...
srcHasMarkup && app.attributes.run(elSelector.name + ' *')
}
srcHasMarkup && app.attributes.run(elSelector.name)
}
}
